...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://instaclone-csr4.onrender.com/api/v1/user/profile/edit', formData, {
                headers: {
    ...
    return (
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div className='flex items-center justify-between bg-gray-100 rounded--cl p-4'>
